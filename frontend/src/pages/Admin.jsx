        ...
        <div className="flex flex-col h-full justify-between">
          <div>
            ...
            <div className="p-4">
              <Link
                to="/Admin"
                className="w-full pl-4 border-b border-white py-3 hover:bg-gray-700 mb-2 flex items-center"
              >
                <FaHome className="inline-block mr-2" /> Overview
              </Link>
              <Link
                to="/Admin/waste-management"
                className="w-full pl-4 border-b border-white py-3 hover:bg-gray-700 mb-2 flex items-center"
              >
                <FaTrash className="inline-block mr-2" /> Waste Management
              </Link>
              <Link
                to="/Admin/distribute-management"
                className="w-full pl-4 border-b border-white py-3 hover:bg-gray-700 mb-2 flex items-center"
              >
                <FaUsers className="inline-block mr-2" /> Redistribution
                Management
              </Link>
              <Link
                to="/Admin/blogs"
              ...
              <Link
                to="/Admin/donors-management"
                className="w-full pl-4 border-b border-white py-3 hover:bg-gray-700 mb-2 flex items-center"
              >
                <FaShoppingCart className="inline-block mr-2" /> Donors
                Management
              </Link>
              <Link
                ...
                className="w-full pl-4 border-b border-white py-3 hover:bg-gray-700 mb-2 flex items-center"
              >
                <FaShoppingCart className="inline-block mr-2" /> Request
                Management
              </Link>
              <Link
                ...
                className="w-full pl-4 border-b border-white py-3 hover:bg-gray-700 mb-2 flex items-center"
              >
                <FaShoppingCart className="inline-block mr-2" /> Stock
                Management
              </Link>
              <Link
                ...
                className="w-full pl-4 border-b border-white py-3 hover:bg-gray-700 mb-2 flex items-center"
              >
                <FaHandshake className="inline-block mr-2" /> Volunteer
                Management
              </Link>
            </div>
          </div>
